...
class Offer extends AbstractHelper
{
    ...
    public function getHeaderRowHtml()
    {
        $html  = '<thead>';
        $html .= '<tr>';
        $html .= '<th class="data-grid-th">'.__('Customer Group').'</th>';
        $html .= '<th class="data-grid-th">'.__('Individual Qty').'</th>';
        $html .= '<th class="data-grid-th">'.__('Global Qty').'</th>';
        $html .= '<th class="data-grid-th">'.__('Discount').'</th>';
        $html .= '<th class="data-grid-th">'.__('Vendor').'</th>';
        $html .= '<th class="data-grid-th">'.__('Type').'</th>';
