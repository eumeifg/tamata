...
class PendingCollection extends AbstractCollection
{
    ...
    protected function _initSelect()
    {
        ...
        $this->_addWebsiteIds(VendorStatus::VENDOR_STATUS_PENDING);
        $this->addFilterToMap('vendor_id', 'main_table.vendor_id');
        $this->addFieldToFilter('rvwd.status', VendorStatus::VENDOR_STATUS_PENDING);
        return $this;
    }
}
