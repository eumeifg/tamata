 ...
 */
namespace Magedelight\Rma\Model\Service;
 ...
 */
class CommentManagement extends \Magento\Rma\Model\Service\CommentManagement
{
    /**
    ...
    public function addComment(\Magento\Rma\Api\Data\CommentInterface $comment)
    {
        ...
        $comment->sendCustomerCommentEmail(true);
