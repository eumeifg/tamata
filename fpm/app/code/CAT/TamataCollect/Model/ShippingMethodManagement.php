...
namespace CAT\TamataCollect\Model;
...
class ShippingMethodManagement extends \Magento\Quote\Model\ShippingMethodManagement
{
    ...
    {
        $output = [];
        $cAddress = $this->extractAddressData($address);
        $shippingAddress = $quote->getShippingAddress();
        $shippingAddress->addData($cAddress);
        $shippingAddress->setCollectShippingRates(true);
        $shippingAddress->setCustomAttributes($cAddress['custom_attributes']);
        $shippingAddress->setNcustomAttributes($cAddress['custom_attributes']);
