 ...
 */
class Items extends \Magedelight\Sales\Block\Sellerhtml\Vendor\Order\Items\AbstractItems
{
    /**
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addChild(
            'update_button',
            \Magedelight\Theme\Block\Sellerhtml\Widget\Button::class,
    ...
    public function isCaptureAllowed()
    {
        ...
        /**
         * @todo check vendor access allowd or not when roles and user management module there.
         */
        return true;
    }
