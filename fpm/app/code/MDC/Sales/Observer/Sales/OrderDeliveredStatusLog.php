...
class OrderDeliveredStatusLog implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $collection->setCurrentStatus(VendorOrder::STATUS_OUT_WAREHOUSE);
        $collection->setStatusChangeTo(VendorOrder::STATUS_COMPLETE);
        $collection->save();
    }
}
