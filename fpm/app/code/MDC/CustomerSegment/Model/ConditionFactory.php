 ...
 * Conditions factory
 */
namespace MDC\CustomerSegment\Model;

class ConditionFactory extends \Magento\CustomerSegment\Model\ConditionFactory
{
    /**
    ...
    public function create($className, array $data = [])
    {
        ...
        if (false === strpos($className, $classNamePrefix) && false === strpos($className, 'MDC')) {
