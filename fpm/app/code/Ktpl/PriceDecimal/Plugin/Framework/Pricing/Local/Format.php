 ...
 *
 * @category    Ktpl
 * @package     Ktpl_PriceDecimal
 * @copyright   Copyright (c) 2019-2020 GiaPhuGroup Co., Ltd. All rights reserved. (http://www.giaphugroup.com/)
 * @license     https://www.giaphugroup.com/LICENSE.txt
 */

namespace Ktpl\PriceDecimal\Plugin\Framework\Pricing\Local;

class Format
{
    /**
     * @var \Ktpl\PriceDecimal\Helper\Data
     */
    protected $priceDecimalHelperData;

    /**
     * @param \Ktpl\PriceDecimal\Helper\Data $priceDecimalHelperData
     */
