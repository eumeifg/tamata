...
class RevertStoreCreditObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $subOrderTotal = $observer->getEvent()->getSubOrderTotal();
        $vendorOrderId = $observer->getEvent()->getVendorOrderId();        
        
        if ($order) {
            $this->revertStoreCreditForOrder->execute($order,$subOrderTotal,$vendorOrderId);
        }
