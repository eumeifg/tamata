 ...
 *
 * Example:
 * <block name="my.block" class="Magedelight\Backend\Block\Template" template="My_Module::template.phtml" >
 *      <arguments>
...
class Template extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->_eventManager->dispatch('sellerhtml_block_html_before', ['block' => $this]);
