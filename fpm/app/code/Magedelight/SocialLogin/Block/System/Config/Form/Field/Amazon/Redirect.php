...
namespace Magedelight\SocialLogin\Block\System\Config\Form\Field\Amazon;

use Magento\Framework\Data\Form\Element\AbstractElement;
use Magento\Config\Block\System\Config\Form\Field as FormField;
use Magedelight\SocialLogin\Helper\Data as Amazonhelper;
...
class Redirect extends FormField
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $redirectUrl = $this->amazonhelper->getAuthUrl('amazon');
