...
class VendorOrderStatusComplete implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if (!$this->scopeConfig->getValue('emailconfiguration/vendor_order_status_complete/enabled') || $order['status'] === VendorOrder::STATUS_IN_TRANSIT || $order['status'] === VendorOrder::STATUS_OUT_WAREHOUSE) {
            return;
        }
