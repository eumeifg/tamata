...
{
    /** Url Path */
    const REQUEST_URL_PATH_EDIT = 'vendor/request/edit';
    const REQUEST_URL_PATH_DELETE = 'vendor/request/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['request_id'])) {
                    $item[$name]['edit'] = [
                        'href' => $this->urlBuilder->getUrl($this->editUrl, ['id' => $item['request_id']]),
                        'label' => __('Edit')
                    ];
                    $item[$name]['delete'] = [
