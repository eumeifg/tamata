...
define([
    ...
    /* Extension for mage.rbProductGallery - Add advanced settings block */
    $.widget('mage.rbProductGallery', $.mage.rbProductGallery, {
        options: {
