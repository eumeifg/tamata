...
class OrderOutWarehouseStatusLog implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $collection->setCurrentStatus(VendorOrder::STATUS_IN_TRANSIT);
        $collection->setStatusChangeTo(VendorOrder::STATUS_OUT_WAREHOUSE);
        $collection->save();
    }
}
