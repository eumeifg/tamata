...
abstract class EmailQueue extends \Magento\Backend\App\Action
{
    /**
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Magedelight_Abandonedcart::abandonedcart_emailqueue';
    ...
    {
        $resultPage->setActiveMenu('Magedelight_Abandonedcart::root')
