...
return [
    ...
    'modules' => [
        ...
        'CAT_Cart' => 1,
        'CAT_Custom' => 1,
        'CAT_CustomerBalance' => 1,
        'CAT_GiftCard' => 1,
        'CAT_OfferPage' => 1,
        'CAT_Patches' => 1,
        'CAT_ProductAssign' => 1,
        'CAT_ProductFeed' => 1,
        'CAT_ReferralProgram' => 0,
        'CAT_TamataCollect' => 1,
        'CAT_VIP' => 1,
        'CAT_SearchPage' => 1,
        'Cminds_Coupon' => 1,
        ...
        'Klarna_Kp' => 0,
        'Ktpl_Ajaxscroll' => 1,
        'Ktpl_BannerManagement' => 1,
        'Magedelight_Backend' => 1,
        'Bss_FacebookPixel' => 1,
        'Magedelight_Theme' => 1,
        'Ktpl_CheckoutAccordion' => 1,
        'Ktpl_CheckoutAccordionExtended' => 1,
        'Ktpl_GoogleMapAddress' => 1,
        'Ktpl_Productslider' => 1,
        'Ktpl_ConflictDetector' => 1,
        'Ktpl_Core' => 1,
        'Ktpl_DealsZone' => 1,
        'Ktpl_DeferJavaScript' => 1,
        'Ktpl_ElasticSearch' => 0,
        'Magedelight_Vendor' => 1,
        'Ktpl_ExtendedCheckout' => 1,
        'MDC_Catalog' => 1,
        'Ktpl_Pushnotification' => 1,
        'Ktpl_CityDropdown' => 1,
        'Mirasvit_Helpdesk' => 1,
        'Ktpl_LazyLoad' => 0,
        'Ktpl_MatrixRate' => 1,
        ...
        'Ktpl_PrintHtml' => 1,
        'Ktpl_ProductLabel' => 1,
        'Magedelight_Catalog' => 1,
        'Ktpl_Cms' => 1,
        'Ktpl_PromoCallouts' => 1,
        'Ktpl_ExtendedPushNotification' => 1,
        'Ktpl_Quickview' => 1,
        'Ktpl_ReorderItem' => 1,
        'Ktpl_Rtl' => 1,
        'Ktpl_SearchAutocomplete' => 0,
        'Ktpl_SearchElastic' => 0,
        'Ktpl_SearchLanding' => 0,
        'Ktpl_SearchMysql' => 0,
        'Ktpl_SocialShare' => 1,
        'Ktpl_SortbyPopularity' => 1,
        'Ktpl_Tookan' => 1,
        'Ktpl_TopCategory' => 1,
        'Ktpl_BarcodeGenerator' => 1,
        'Ktpl_Wishlist' => 1,
        'MDC_Backend' => 1,
        'Magedelight_Quote' => 1,
        'MDC_CategoryForMobile' => 1,
        'MDC_Checkout' => 1,
        'Magedelight_Commissions' => 1,
        'MDC_Custom' => 1,
        'MDC_CustomMobileApi' => 1,
        'MDC_Customer' => 1,
        'MDC_CustomerBalance' => 1,
        'MDC_CustomerSegment' => 1,
        'Magedelight_Base' => 1,
        'MDC_GetItTogether' => 1,
        'MDC_GoogleMapAddress' => 1,
        'MDC_InventorySourceDeductionApi' => 1,
        'MDC_Microsite' => 1,
        'MDC_MobileBanner' => 1,
        'MDC_OrderConfirmCode' => 1,
        'MDC_OrderDeviceId' => 1,
        'MDC_PickupPoints' => 1,
        'MDC_ProvinceCenter' => 1,
        'MDC_Quote' => 1,
        'Ktpl_Warehousemanagement' => 1,
        'MDC_Sales' => 1,
        'MDC_SalesRule' => 1,
        'MDC_SearchTerms' => 1,
        'MDC_Shippingmatrix' => 1,
        'Magedelight_Checkout' => 1,
        'MDC_Vendor' => 1,
        'MDC_VendorCommissions' => 1,
        'MDC_VisualMerchandiser' => 1,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'MagePal_Core' => 1,
        'MagePal_GmailSmtpApp' => 1,
        'Magedelight_Abandonedcart' => 0,
        'Magedelight_Authorization' => 1,
        'Magedelight_Rma' => 1,
        'Magedelight_SocialLogin' => 1,
        'Ktpl_CategoryView' => 1,
        'Magedelight_CatalogGraphQl' => 1,
        'MDC_SocialLogin' => 1,
        'MDC_Commissions' => 1,
        'Magedelight_ConfigurableProduct' => 1,
        'Magedelight_Customer' => 1,
        'Magedelight_MobileInit' => 1,
        'Magedelight_OffersImportExport' => 1,
        'Magedelight_OffersImportExportChild' => 1,
        'Magedelight_ProductAlert' => 1,
        'Ktpl_ExtendedCheckoutApi' => 1,
        'Magedelight_Review' => 1,
        'MDC_Rma' => 1,
        'Ktpl_ExtendedAdminSalesGrid' => 1,
        'Magedelight_SearchAutocomplete' => 1,
        'Magedelight_Shippingmatrix' => 1,
        'MDC_Customerapproval' => 1,
        'Magedelight_StoreSwitcher' => 1,
        'Magedelight_TargetRule' => 1,
        'Magedelight_Tax' => 1,
        'Ktpl_ProductView' => 1,
        'Magedelight_User' => 1,
        'Ktpl_MegaMenu' => 1,
        'Magedelight_VendorPromotion' => 1,
        'Magedelight_Wishlist' => 1,
        'Mageplaza_Core' => 1,
