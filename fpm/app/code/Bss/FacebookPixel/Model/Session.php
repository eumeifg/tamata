...
class Session extends \Magento\Framework\Session\SessionManager
{
    ...
    {
        if ($this->hasBuyNow()) {
            $data = $this->getData('buy_now');
            $this->unsetData('buy_now');
            return $data;
        }
        return null;
    }
     ...
     * @return \Bss\FacebookPixel\Model\Session $this
     */
    public function setAddressSave($data)
    {
        $this->setData('address_save', $data);
        return $this;
    }
    ...
    {
        if ($this->hasAddressSave()) {
            $data = $this->getData('address_save');
            $this->unsetData('address_save');
            return $data;
        }
        return null;
    }
     ...
     * @return bool
     */
    public function hasAddressSave()
    {
        return $this->hasData('address_save');
    }
    ...
    {
        if ($this->hasFacebook()) {
            $data = $this->getData('facebook');
            $this->unsetData('facebook');
            return $data;
        }
        return null;
    }
    ...
    {
        if ($this->hasGoogle()) {
            $data = $this->getData('google');
            $this->unsetData('google');
            return $data;
        }
        return null;
    }
