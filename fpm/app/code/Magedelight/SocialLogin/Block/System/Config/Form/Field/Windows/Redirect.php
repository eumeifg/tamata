...
namespace Magedelight\SocialLogin\Block\System\Config\Form\Field\Windows;

use Magento\Framework\Data\Form\Element\AbstractElement;
use Magento\Config\Block\System\Config\Form\Field as FormField;
use Magedelight\SocialLogin\Helper\Data as Windowshelper;
...
class Redirect extends FormField
{
     ...
     * @param Windowshelper $Windowshelper
     */
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $redirectUrl = $this->windowshelper->getAuthUrl('windows');
