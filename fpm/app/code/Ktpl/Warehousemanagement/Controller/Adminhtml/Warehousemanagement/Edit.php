...
class Edit extends \Ktpl\Warehousemanagement\Controller\Adminhtml\Warehousemanagement
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getParam('deliverytype') == 0) :
            $resultPage->getConfig()->getTitle()->prepend(__('Product Delivery : From Vendor to Warehouse'));
        else :
            $resultPage->getConfig()->getTitle()->prepend(__('Product Delivery : From Warehouse to Customer'));
        endif;
