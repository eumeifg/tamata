...
define([
    ...
    return Component.extend({
        defaults: {
            ...
            shippingFormTemplate: 'Ktpl_GoogleMapAddress/shipping-address/form',
        ...
        setShippingInformation: function () {
            if (this.validateShippingInformation()) {
                ...
                setShippingInformationAction().done(
                    function () {
                            stepNavigator.next();
                        /*....Start check for location field is empty or not....*/
                        /*if($(".input-text.location").val() != "") {
                        } else {
                            alert("Please enter location");
                            $( ".input-text.location" ).focus();
                            $( "#location" ).addClass("_error");
                        }*/
                        /*....End check for location field is empty or not....*/
                    }
                );
            }
        },
