...
interface OrderInterface extends \Magento\Framework\Api\ExtensibleDataInterface {
     ...
     *
     * @return \MDC\Sales\Api\Data\OrderItemInterface[] Array of items.
     */
     ...
     *
     * @param \MDC\Sales\Api\Data\OrderItemInterface[] $items
     * @return $this
     */
     ...
     * @return string|null
     */
    public function getSubOrderStatuses();

    /**
     * @param string $shipmentId
     * @return $this
     */
    public function setSubOrderStatuses($shipmentId);
     ...
     * @return float|null
     */
    public function getStoreCreditUse();

    /**
     * @param float $amount
     * @return $this
     */
    public function setStoreCreditUse($amount);

    /**
     * @return string|null
     */
    public function getVoCanceledBy();

    /**
     * @param string $voCanceledBy
     * @return $this
     */
    public function setVoCanceledBy($voCanceledBy);
    ...
    /**
     * @param string $shippingHistory
     * @return $this
     */
    public function setShippingHistory($shippingHistory);

    /**
     * @return string|null
     */
    public function getSortingHistory();

    /**
     * @param string $sortingHistory
     * @return $this
     */
    public function setSortingHistory($sortingHistory);
    ...
    /**
     * @param string $readyToShip
     * @return $this
     */
    public function setReadyToShip($readyToShip);
     ...
     * @return string|null
     */
    public function getIsShelvedTimestamp();

    /**
     * @param string $isShelvedTimestamp
     * @return $this
     */
    public function setIsShelvedTimestamp($isShelvedTimestamp);

    /**
     * @return string|null
     */
    public function getReadyToShipTimestamp();

    /**
     * @param string $readyToShipTimestamp
     * @return $this
     */
    public function setReadyToShipTimestamp($readyToShipTimestamp);
