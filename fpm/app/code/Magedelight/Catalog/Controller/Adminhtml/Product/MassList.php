...
class MassList extends \Magedelight\Catalog\Controller\Adminhtml\Product
{
    /**
    ...
    public function execute()
    {
        ...
        if (!is_array($ids) || empty($ids)) {
            ...
            try {
                ...
                $collection->getSelect()
                    ->joinLeft(
                        ['rbvwd' => 'md_vendor_website_data'],
                        "rbvwd.vendor_id = rbv.vendor_id",
                        ['rbvwd.name as vendor_name']
                    );
                $this->vendorProductResource->updateStatusForProducts($ids, VendorProduct::STATUS_LISTED);
        ...
        $this->_redirect('*/*/', ['status'=>  VendorProduct::STATUS_UNLISTED]);
    }
}
