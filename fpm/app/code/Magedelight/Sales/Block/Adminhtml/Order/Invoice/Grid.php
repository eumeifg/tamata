 ...
 */
namespace Magedelight\Sales\Block\Adminhtml\Order\Invoice;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('action', [
            ...
            'renderer' => \Magedelight\Sales\Block\Adminhtml\Order\Renderer\Invoicelink::class,
        ]);
    ...
    public function getRowUrl($row)
    {
        return $this->getUrl(
            'sales/invoice/view',
            ['store' => $this->getRequest()->getParam('store'), 'invoice_id' => $row->getEntityId()]
        );
    }
