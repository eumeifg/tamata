...
class Price extends \Magento\Framework\App\Helper\AbstractHelper 
{
    ...
    public function getConfigurableProductPriceRange($_product)
    {
        ...
        if($this->_priceHelper->currency($_minPrice, true, false) == $this->_priceHelper->currency($_maxPrice, true, false)) {
            return $this->_priceHelper->currency($_minPrice, true, false);
        }
