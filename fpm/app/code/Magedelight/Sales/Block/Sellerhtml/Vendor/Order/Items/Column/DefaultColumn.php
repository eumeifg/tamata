...
/**
 * vendor order column renderer
 */
class DefaultColumn extends \Magedelight\Sales\Block\Sellerhtml\Vendor\Order\Items\AbstractItems
{
    /**
     * Option factory
     *
    ...
    public function getItem()
    {
        ...
        if ($item instanceof Item || $item instanceof QuoteItem ||
            $item instanceof InvoiceItem || $item instanceof CreditmemoItem) {
            return $item;
        } else {
