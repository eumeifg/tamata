...
class BundlePackTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testGetProductDiscount($discountType, $productId, $applyForParents, $isParent, $result)
    {
        ...
        $this->assertEquals($result, $this->block->getProductDiscount($pack, $productId, $isParent));
    }
