...
use Magedelight\Catalog\Model\ResourceModel\Product\Indexer\Price\IndexTableStructure;

/**
 * Downloadable Product Price Indexer Resource model
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Downloadable implements DimensionalIndexerInterface
{
    /**
     * @var BaseFinalPrice
     */
    ...
    private function applyDownloadableLink(
        \Magento\Catalog\Model\ResourceModel\Product\Indexer\Price\IndexTableStructure $temporaryPriceTable,
        array $dimensions
    ) {
