 ...
 */
namespace Magedelight\OffersImportExport\Block\Adminhtml\Offers\Update\Edit\Tab;
...
class Offers extends Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Update Offers')]);
