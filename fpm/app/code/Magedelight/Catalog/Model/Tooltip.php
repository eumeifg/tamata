...
class Tooltip extends \Magento\Framework\Model\AbstractModel
{
    /**
    ...
    {
        $this->_init(\Magedelight\Catalog\Model\ResourceModel\Tooltip::class);
    }

    /**
     * Retrieve store tooltip by given attribute id.
     *
     ...
     */
    public function getStoreTooltipsByAttributeId($attributeId)
    {
