...
class View extends \Magento\Rma\Block\Returns\View
{
    ...
    public function canShowPackageSlip($rma)
    {
        return (bool)(!($this->getRma()->getStatus() == \Magento\Rma\Model\Rma\Source\Status::STATE_CLOSED ||
                $this->getRma()->getStatus() == \Magento\Rma\Model\Rma\Source\Status::STATE_PROCESSED_CLOSED));
    }
     ...
     * @return string
     */
    public function getPackingSlipUrl($rma)
    {
        return $this->getUrl('rma/tracking/packagePrint/', ['entity_id' => $rma->getEntityId()]);
    }
}
