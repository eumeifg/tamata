 ...
 */
namespace Magedelight\OffersImportExport\Block\Adminhtml\Offers\Export\Edit\Tab;
...
class Offers extends Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Export Offers')]);
        ...
        $fieldset->addField(
            ...
            'button',
            [
                'name'      => __('Download Vendor Data'),
                'value'     => __('Download Vendor Data'),
            ]
        );
