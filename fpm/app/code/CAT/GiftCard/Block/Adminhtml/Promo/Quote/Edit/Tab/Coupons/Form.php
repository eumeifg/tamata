...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     *
     * @return \CAT\GiftCard\Block\Adminhtml\Promo\Quote\Edit\Tab\Coupons\Form
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry(\CAT\GiftCard\Model\RegistryConstants::CURRENT_GIFT_CARD_RULE);
        $ruleId = $model->getId();
    ...
    {
        return $this->getUrl('giftcardrule/rules/generate');
    }
}