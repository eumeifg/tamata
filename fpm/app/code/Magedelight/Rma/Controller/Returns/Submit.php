...
namespace Magedelight\Rma\Controller\Returns;
 ...
 */
class Submit extends \Magento\Rma\Controller\Returns\Submit implements HttpPostActionInterface
{
    /**
     * @var RmaFactory
     */
    ...
    public function __construct(
        ...
        \Magento\Rma\Helper\Data $rmaHelper = null
    ) {
        parent::__construct(
            $context,
            $coreRegistry,
        ...
        if ($post && !empty($post['items'])) {
            ...
            try {
                ...
                if (isset($post['rma_comment']) && !empty($post['rma_comment'])) {
                    ...
                    $comment->setVendorId($post['vendor_id']);
                    $comment->setVendorName($post['vendor_name']);
