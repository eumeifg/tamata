...
require(
    ...
    function (jQuery, modal) {
        ...
        var options = {
            ...
            responsive: true,
            innerScroll: true,
            title: jQuery.mage.__('Login/Registration'),
            buttons: false,
        ...
        jQuery(document).on('click touchstart', '.header li.md-custom-toplink a', function () {
            ...
            /*....To set url for login link redirection....*/
            ...
            console.log(baseUrl);*/
            /*if(checkoutPath == "/checkout/cart/") {
                jQuery("#currenturl").val(baseUrl + '/checkout');
            } else {*/
                jQuery("#currenturl").val(currentUrl);
            /*}*/

        });

        /*....To set url go-to-checkout button link in mini cart and cart page....*/
        jQuery(document).on('click touchstart', '.header li.md-custom-toplink.even.last a', function () {
            var baseUrl = window.location.origin;
            jQuery("#currenturl").val(baseUrl + '/checkout');
