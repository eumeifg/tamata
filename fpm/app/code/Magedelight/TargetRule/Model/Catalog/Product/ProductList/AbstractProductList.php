...
use Magedelight\TargetRule\Model\Product\AbstractProduct;

/**
 * TargetRule Catalog Product List Abstract Model
 *
 * @SuppressWarnings(PHPMD.LongVariable)
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
abstract class AbstractProductList extends AbstractProduct
{
    /**
    ...
    public function getProduct()
    {
        ...
        $collection->addFieldToFilter('entity_id', ['in' => $this
        ->getProductId()]);
