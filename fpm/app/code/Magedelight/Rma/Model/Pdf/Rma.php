...
namespace Magedelight\Rma\Model\Pdf;
...
//    }
     ...
     */
    public function getPackagePdf($rmaArray = [])
    {
        $this->_beforeGetPdf();
        ...
        $page->drawRectangle(25, $this->y - 20, 570, $this->y - 75);
        ...
        $page->setFillColor(new \Zend_Pdf_Color_GrayScale(0));
        $this->_setFontRegular($page);
        $page->drawText(__('Customer  Address (Ship From)'), 35, $this->y - 10, 'UTF-8');

        $page->drawText(__('Return Address (Ship To)'), 315, $this->y - 10, 'UTF-8');
