...
class Ticket extends \Magento\Framework\Model\AbstractModel implements TicketInterface
{
    ...
    {
        return $this->getData(self::KEY_STATUS_TITLE);
    }
    ...
    {
        return $this->setData(self::KEY_STATUS_ID, $statusTitle);
    }
    ...
    {
        return $this->getData(self::KEY_HISTORY);
    }
    ...
    {
        return $this->setData(self::KEY_HISTORY, $history);
    }
}
