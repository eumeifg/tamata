...
define([
    ...
    AdminOrder.prototype = {
        initialize : function(data){
            ...
            this.orderItemHasNoVendor = false;
        ...
        itemsHasNoVendorItem : function(){
            this.orderItemHasNoVendor = true;
        },
        ...
        submit : function()
        {
            if (this.orderItemHasNoVendor) {
                alert({
                    content: "First, select vendor for all items or remove items without vendors."
                });
            } else {
