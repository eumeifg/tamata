...
namespace Ktpl\ConflictDetector\Block\Adminhtml;
...
class ConflictList extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ktpl_ConflictDetector::list.phtml';

    /**
     * \Ktpl\ConflictDetector\Model\Config\Reader\Do
     */
    protected $dom;
    ...
    /**
     * @param \Ktpl\ConflictDetector\Model\Config\Reader\Dom
     * @param \Magento\Framework\ObjectManagerInterface
     * @param \Magento\Backend\Block\Template\Context
     * @param array
     */
    public function __construct(
        \Ktpl\ConflictDetector\Model\Config\Reader\Dom $dom,
