define([
    ...
    Autocomplete.prototype = {
        init: function (config) {
            ...
            this.placeholderSelector = '.ktpl-searchautocomplete__autocomplete';
            
            this.wrapperSelector = '.ktpl-searchautocomplete__wrapper';
            
            this.additionalColumnSelector = 'ktpl-2-cols';
                        ...
                        if ($.trim(word)) {
                            ...
                            if ("span".indexOf(word.toLowerCase()) == -1) {
                                html = html.replace(new RegExp('(' + word + '(?![^<>]*>))', 'ig'), function ($1, match) {
                                    return '<span class="ktpl-searchautocomplete__highlight">' + match + '</span>';
                                });
                            }
                        }
                    });
        ...
        clickHandler: function (event) {
            if (!event) {
                ...
                if ($(event.target).hasClass("ktpl-searchautocomplete__close")) {
                    $('body').removeClass('searchautocomplete__active');
                    this.$placeholder().removeClass('_active');
                }
            }
        ...
        $spinner: function () {
            return this.$placeholder().find(".ktpl-searchautocomplete__spinner");
        },
        ...
        processApplyBinding: function (data) {
            ...
            if (this.config.layout == '2columns' && data.totalItems > 1) {
                var result = {};
