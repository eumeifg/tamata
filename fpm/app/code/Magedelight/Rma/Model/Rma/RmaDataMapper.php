...
namespace Magedelight\Rma\Model\Rma;

class RmaDataMapper extends \Magento\Rma\Model\Rma\RmaDataMapper
{
    /**
    ...
    public function prepareNewRmaInstanceData(array $saveRequest, \Magento\Sales\Model\Order $order)
    {
        ...
        $rmaData = [
            ...
            'vendor_id' => $saveRequest['do_as_vendor'],
            'vendor_name' => $saveRequest['vendor_name'],
        ];
        return $rmaData;
    }
