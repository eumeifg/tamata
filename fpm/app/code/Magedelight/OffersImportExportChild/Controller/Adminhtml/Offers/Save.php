 ...
 */
namespace Magedelight\OffersImportExportChild\Controller\Adminhtml\Offers;

use Magedelight\Catalog\Model\Product;
use Magedelight\Catalog\Model\ProductRequestManagement;
use Magento\ConfigurableProduct\Model\Product\Type\Configurable;

class Save extends \Magedelight\OffersImportExport\Controller\Adminhtml\Offers\Save
{
    /**
     *
    ...
    public function execute()
    {
        ...
        try {
            if (isset($_filesParam['vendor_offers'])) {
                ...
                if (count($errors) > 0) {
                    $this->messageManager->addErrorMessage(__('Validation Results Test %1', implode(" \n", $errors)));
                } else {
