...
class VendorProductAdminUnList implements ObserverInterface
{
    const XML_PATH_EMAIL_TEMPLATE = 'emailconfiguration/vendor_product_unlist/template';
    ...
    {
        if ($this->scopeConfig->getValue('emailconfiguration/vendor_product_unlist/enabled')) {
