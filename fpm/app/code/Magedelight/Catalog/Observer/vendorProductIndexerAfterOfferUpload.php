...
class vendorProductIndexerAfterOfferUpload implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $this->_helper->updateMultipleProductStock($event, 'offerupload', $marketplaceProductIds);
    }
}
