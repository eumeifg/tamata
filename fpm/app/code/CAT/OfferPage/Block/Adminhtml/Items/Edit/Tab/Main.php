...
namespace CAT\OfferPage\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_cat_offerpage_items');
        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $form->setHtmlIdPrefix('item_');
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Offer Information')]);
        if ($model->getId()) {
            $fieldset->addField('offerpage_id', 'hidden', ['name' => 'offerpage_id']);
        }
        $fieldset->addField(
            'title',
            'text',
