...
use Magedelight\CatalogGraphQl\DataProvider\Product\LayeredNavigation\AttributeOptionProvider;
use Magento\CatalogGraphQl\DataProvider\Product\LayeredNavigation\Formatter\LayerFormatter;
use Magento\Framework\Api\Search\AggregationInterface;
use Magento\Framework\Api\Search\AggregationValueInterface;
use Magento\Framework\Api\Search\BucketInterface;

class Attribute extends \Magedelight\CatalogGraphQl\DataProvider\Product\LayeredNavigation\Builder\Attribute
{
    /**
     * @var string
    ...
    public function build(AggregationInterface $aggregation, ?int $storeId): array
    {
        ...
        foreach ($this->getAttributeBuckets($aggregation) as $bucket) {
            ...
            if ($bucketName === 'special_price_bucket') { continue; }
