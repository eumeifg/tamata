    ...
    return {
        ...
        getRender: function (
            ...
            if (selectFlag) {
                ...
                html = "<div class='control date-field-container'><input class='date-from' type='text' onchange='updateAttributeValues(this,\""+attributeName+"\");' id='date_" + eleId + "' name='" + eleName + "' /></div>";
            } else if (attributeName == 'special_to_date') {
                html = "<div class='control date-field-container'><input class='date-to' type='text' onchange='updateAttributeValues(this,\""+attributeName+"\");' id='date_" + eleId + "' name='" + eleName + "' /></div>";
                ...
                html = "<input type='text' class='input-text vendor-qty' onchange='updateAttributeValues(this,\""+attributeName+"\");' id='" + eleId + "' name='" + eleName + "' />";
                ...
                html = "<input type='text' class='input-text required-entry price-update' onchange='updateAttributeValues(this,\""+attributeName+"\");' id='" + eleId + "' name='" + eleName + "' data-validate=\"{required:true, 'validate-greater-than-zero':true, 'validate-number': true}\"/>";
            } else if (attributeName == 'special_price') {
                html = "<input type='text' class='price-update' onchange='updateAttributeValues(this,\""+attributeName+"\");' id='" + eleId + "' name='" + eleName + "' data-validate=\"{'validate-greater-than-zero':true, 'validate-number': true, 'validate-less-than-price':true}\"/>";
