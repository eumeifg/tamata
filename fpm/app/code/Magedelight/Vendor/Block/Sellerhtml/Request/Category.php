    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            if (!$child->hasChildren()) {
                $checked = in_array($childId, $vendorCats, true) ? ' checked = "checked"' : '';
            ...
            if ($child->hasChildren()) {
                $checked = in_array($childId, $vendorCats, true) ? ' checked = "checked"' : '';
                $html .= '<input type="checkbox" name="selectall" id="slt-' . $childId . '" value="' . $childId;
                $html .= '" title="' . $child->getName() . '" class="checkbox slt-chk" />';
