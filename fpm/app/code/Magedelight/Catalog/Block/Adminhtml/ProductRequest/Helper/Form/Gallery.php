 ...
 */
namespace Magedelight\Catalog\Block\Adminhtml\ProductRequest\Helper\Form;
...
class Gallery extends \Magento\Framework\View\Element\AbstractBlock
{
    ...
    {
        return $this->registry->registry('vendor_product_request')->getData('images') ?: null;
    }
    ...
    {
        return $this->registry->registry('vendor_product_request');
    }
