 ...
 */
namespace Magedelight\Abandonedcart\Block\Adminhtml\Rule\Edit\Tab;
...
class Conditions extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    private function getRuleFactory()
    {
        if ($this->ruleFactory === null) {
            $this->ruleFactory = ObjectManager::getInstance()->get(\Magedelight\Abandonedcart\Model\RuleFactory::class);
        }
    ...
    {
        $model = $this->_coreRegistry->registry('magedelight_abandonedcart_rule');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'abandonedcart_rule_form')
    {
        if (!$model) {
