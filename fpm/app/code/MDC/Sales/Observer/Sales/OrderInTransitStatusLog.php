...
class OrderInTransitStatusLog implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $collection->setCurrentStatus(VendorOrder::STATUS_SHIPPED);
        $collection->setStatusChangeTo(VendorOrder::STATUS_IN_TRANSIT);
        $collection->save();
    }
}
