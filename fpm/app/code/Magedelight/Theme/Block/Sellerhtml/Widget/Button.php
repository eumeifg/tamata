 ...
 */
namespace Magedelight\Theme\Block\Sellerhtml\Widget;

/**
 * Button widget
 */
class Button extends \Magedelight\Theme\Block\Sellerhtml\Widget
{
    /**
    ...
    {
        $this->setTemplate('Magedelight_Theme::widget/button.phtml');
        parent::_construct();
    }
