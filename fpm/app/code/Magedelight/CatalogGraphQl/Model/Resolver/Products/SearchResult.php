...
namespace Magedelight\CatalogGraphQl\Model\Resolver\Products;
...
class SearchResult extends \Magento\CatalogGraphQl\Model\Resolver\Products\SearchResult
{
    ...
    /**
     * Retrieve min price amount for the search
     *
     * @return string
     */
    public function getMinPrice(): string
    {
        return $this->data['minPrice'] ?? '0.000000';
    }

    /**
     * Retrieve max price amount for the search
     *
     * @return string
     */
    public function getMaxPrice(): string
    {
        return $this->data['maxPrice'] ?? '0.000000';
    }
