...
class Category extends Multiselect
{
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<div id="slider-category-select" 
        class="admin__field" data-bind="scope:\'sliderCategory\'" 
        data-index="index">';
        ...
        $html .= '<div 
        class="admin__field admin__field-group-additional admin__field-small" 
                            ...
                            "sliderCategory": {
                                ...
                                "children": {
                                    "slider_select_category": {
                                        "component": "Ktpl_Productslider/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Ktpl_Productslider::category');
