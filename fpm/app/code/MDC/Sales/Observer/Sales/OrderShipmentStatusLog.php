...
class OrderShipmentStatusLog implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $collection->setCurrentStatus(VendorOrder::STATUS_PACKED);
        $collection->setStatusChangeTo(VendorOrder::STATUS_SHIPPED);
        $collection->save();
