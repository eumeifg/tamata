 ...
 */
namespace Magedelight\Rma\Block\Adminhtml\Rma\NewRma\Tab\Items\Order;
...
class Grid extends \Magento\Rma\Block\Adminhtml\Rma\NewRma\Tab\Items\Order\Grid
{
    ...
    protected function _afterLoadCollection()
    {
        ...
        $vendorId = intval($this->getRequest()->getParam('do_as_vendor'));
        ...
        foreach ($this->getCollection() as $item) {
            ...
            if ($item->getProductType() == \Magento\Catalog\Model\Product\Type::TYPE_BUNDLE && !isset(
             ...
             /* Removed Another Vendor Product */
