...
namespace Ktpl\LazyLoad\Plugin;
...
class BlockPlugin
{
     ...
     * Lazy store config
     *
     * @var \Ktpl\LazyLoad\Model\Config
     */
    protected $config;
     ...
     * @param null|\Ktpl\LazyLoad\Model\Config $config
     */
    public function __construct(
        ...
        $this->config = $config ?: $objectManager->get(
            \Ktpl\LazyLoad\Model\Config::class
        );
    }
    ...
    public function afterToHtml(\Magento\Framework\View\Element\AbstractBlock $block, $html)
    {
        ...
        $pixelSrc = 'src="' . $block->getViewFileUrl('Ktpl_LazyLoad::images/pixel.jpg') . '"';
        $tmpSrc = 'TMP_SRC';
