...

{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        if ($this->helper->isEnabled()) {
            ...
            if ($event->getProduct()->getTypeId() == Configurable::TYPE_CODE || $event->getProduct()->getTypeId() == Giftcard::TYPE_GIFTCARD) {
                return $this;
            }
            ...
            if ($vendorId) {
                ...
                $this->vendorProductData = $this->helper->getCustomProductData($vendorId, $productId);
                //$this->helper->getVendorProduct($vendorId, $productId);
