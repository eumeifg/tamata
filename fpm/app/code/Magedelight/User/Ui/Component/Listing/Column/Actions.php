 ...
 */
namespace Magedelight\User\Ui\Component\Listing\Column;
...
class Actions extends Column
{
    ...
    /** Url path */
    const VENDOR_URL_PATH_EDIT = 'vendor/manage/edit';
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (array_key_exists('websites', $item)) {
                    ...
                    foreach ($websiteIds as $websiteId) {
                        $storeId = (array_key_exists('store_id', $item)) ? $item['store_id'] : $this->storeManager->getWebsite($websiteId)->getDefaultStore()->getId();
