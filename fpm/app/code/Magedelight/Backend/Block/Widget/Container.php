...
class Container extends \Magedelight\Backend\Block\Template implements ContainerInterface
{
    /**#@+
     ...
     * @param array $data
     */
    public function __construct(\Magedelight\Backend\Block\Widget\Context $context, array $data = [])
    {
