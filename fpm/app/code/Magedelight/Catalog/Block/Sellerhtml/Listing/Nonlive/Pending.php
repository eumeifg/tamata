...
class Pending extends \Magedelight\Catalog\Block\Sellerhtml\Listing\Nonlive
{
    protected function _construct()
    {
        parent::_construct();
        $this->setCollection($this->getPendingProductRequests());
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $pager = $this->getLayout()->createBlock(
            ...
            'mylisting.pending.result.list.pager'
        );
