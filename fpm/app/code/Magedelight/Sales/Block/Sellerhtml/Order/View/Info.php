 ...
 */
namespace Magedelight\Sales\Block\Sellerhtml\Order\View;
 ...
 */
class Info extends \Magedelight\Sales\Block\Sellerhtml\Order\AbstractOrder
{
    /**
     * Customer service
     *
    ...
    public function __construct(
        ...
        parent::__construct($context, $registry, $frontendHelper, $data);
    }
    ...
    {
        return $this->getUrl('rbsales/order/view', ['order_id' => $orderId]);
    }
    ...
    public function getAddressEditLink($address, $label = '')
    {
        if ($this->_authorization->isAllowed('Magento_Sales::actions_edit')) {
            ...
            $url = $this->getUrl('rbsales/order/address', ['address_id' => $address->getId()]);
     ...
     * @return \DateTime
     */
    public function getOrderFrontendDate($createdAt)
    {
    ...
    {
        return $this->getRequest()->getParam('vendor_order_id');
    }
