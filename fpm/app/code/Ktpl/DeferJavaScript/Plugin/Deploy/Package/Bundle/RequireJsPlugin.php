...
namespace Ktpl\DeferJavaScript\Plugin\Deploy\Package\Bundle;
...
class RequireJsPlugin
{
     ...
     * @var string
     */
    const BUNDLING_OPTIMIZATION_ENABLED = 'ktpldeferjavascript/general/enable_js_bundling_optimization';

    /**
     * @var string
     */
    const INCLUDE_IN_BUNDLING = 'ktpldeferjavascript/general/included_in_bundling';
