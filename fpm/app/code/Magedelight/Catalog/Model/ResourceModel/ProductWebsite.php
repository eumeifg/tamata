...
class ProductWebsite extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     * Event Manager
     *
    ...
    {
        $this->_init('md_vendor_product_website', 'row_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Magedelight\Catalog\Model\ProductWebsite $object
     * @return $this
     */
