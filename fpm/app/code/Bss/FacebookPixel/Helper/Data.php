...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return bool
     */
    public function isAddressSave($scope = null)
    {
        return $this->scopeConfig->getValue(
            'bss_facebook_pixel/event_tracking/address_save',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
     ...
     * @return bool
     */
    public function isBuyNow($scope = null)
    {
        return $this->scopeConfig->getValue(
            'bss_facebook_pixel/event_tracking/buynow',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
     ...
     * @return bool
     */
    public function isSocialLogin($scope = null)
    {
        return $this->scopeConfig->getValue(
            'bss_facebook_pixel/event_tracking/social_login_save',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $scope
        );
    }
